# Uninstall Microsoft OpenJDK 16 x64

$AppName =  "Microsoft Build of OpenJDK with Hotspot 16.*(x64)"
$ProcessNames = @("java","javaw")

# MSI GUID-style uninstall
# uninstall info lives in x64 space
...
$AppInfo = Get-ChildItem -Path $UninstallRoot | Where-Object {$_.getValue("displayname") -like $AppName} | Select-Object -First 1
