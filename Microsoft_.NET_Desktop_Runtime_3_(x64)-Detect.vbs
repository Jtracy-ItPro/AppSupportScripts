' Detect Windows Desktop Runtime 3 (x64)
...
' This is a bundle that includess .Net Core 3 Runtime.

' Note: if you install the .Net Core 3 SDK, you also get these components.
...
MyAppName = "Microsoft Windows Desktop Runtime - 3\..*(x64)"
