' Detect PhysX System Software (X64)
...
' Version is at the end of the string. We will match it with regex this time. 

 in the middle of the string for this app. So I have to do a regex match. I can't use InStr with a wildcard in the middle.

' The app I want to detect. Use a regex for a wildcard that covers the verison.

' I have no idea what "hotspot" actually is.

MyAppName = "NVIDIA PhysX System Software .*"
